    ...
    >
      ...
      <div class="information__content">
        <div class="information__image flex flex-col items-center">
          <img
            :src="require('@/shared/assets/images/homes/home1.png')"
            alt=""
          />
          <div class="img__btns flex flex-row mt-5 gap-x-2">
            <MyButton :theme="'green'" class="text-sm">
              <svg
                width="19"
                height="18"
                viewBox="0 0 19 18"
        ...
        <div class="information__textBlock flex flex-col">
          ...
          <div class="textBlock__item">
            <div class="item__label">Страна:</div>
            <div class="item__text">Россия</div>
          </div>
          <div class="textBlock__item">
            <div class="item__label">Название субъекта РФ (регион):</div>
            <div class="item__text">Московская область</div>
          </div>
          <div class="textBlock__item">
            <div class="item__label">Метро:</div>
            <div class="item__text">Машиностроителей</div>
          </div>
          <div class="textBlock__item">
            <div class="item__label">Название ЖК:</div>
            <div class="item__text">ЖК Невский</div>
          </div>
          <div class="textBlock__item">
          ...
          <div class="textBlock__item">
            <div class="item__label">Застройщик:</div>
            <div class="item__text">
              <span class="text-grey-400">Неуказано</span>
            </div>
          </div>
          <div class="textBlock__item">
            <div class="item__label">Тип оплаты:</div>
            <div class="item__text">
              <span class="text-grey-400">Неуказано</span>
            </div>
          </div>
          <div class="textBlock__item">
            <div class="item__label">Этажность:</div>
            <div class="item__text">1 - 20</div>
          </div>
          <div class="textBlock__item">
            <div class="item__label">Этажность:</div>
            <div class="item__text">
              Школа, <br />Детский сад, <br />
              Детские площадки, <br />Спортивные площадки
            </div>
          </div>
          <div class="textBlock__item">
            <div class="item__label">Сайт:</div>
            <div class="item__text">
              <span class="text-grey-400">Неуказано</span>
            </div>
          </div>
          <div class="textBlock__item">
            <div class="item__label">Отдел продаж:</div>
            <div class="item__text">
              <span class="text-grey-400">Неуказано</span>
            </div>
          </div>

    ...
    <template v-slot:default>
      <form class="form addHome__form">
        ...
        <div class="form__item">
          ...
          <InputText type="text" id="address" />
        </div>
        <div class="form__item">
          <label for="metro">Метро</label>
          <InputText type="text" id="metro" />
        </div>
        <div class="form__item">
        ...
        <div class="form__item">
          ...
          <div class="p-inputgroup flex flex-row !items-center gap-4">
            ...
            <Calendar date-format="H:m" :timeOnly="true" :show-icon="true">
              <template #dropdownicon>
                <svg
                  width="16"
                  height="17"
...
const titleForm = ref<string>("Добавить дом");
</script>
